                    ...
                    <div className="card-body">
                        <form action="">
                            <div className="form-group mb-3">
                                ...
                                <input type="text" name="email" className="form-control" id="name" placeholder="Type Your Name" />
                            </div>
                            <div className="form-group mb-3">
                            ...
                            <div className="form-group mb-3">
                                ...
                                <input type="password" name="confirm_password" className="form-control" id="confirm_password" placeholder="Retype Your Password" />
                            </div>
                            <div className="form-group mb-3">
